        ...
        <div class="row">
            <div class="col-md-6">
                <div class="caree-mobile">
                    ...
                    <h1>Project Manager <br>Tech and Delivery</h1>
                    <div class="sub-head">
                        <span>Exp: 4 - 7 Years</span>
                        <span>
                    ...
                    <div class="job-content">
                        ...
                        <div class="response-para">
                            <div class="response-details">
                                ...
                                <ul>
                                    <li>Lorem ipsum is a placeholder text commonly used to demonstrate the </li>
                                    <li>Lorem ipsum is a placeholder text commonly used to demonstrate the </li>
                                    <li>Lorem ipsum is a placeholder text commonly used to demonstrate the </li>
                                    <li>Lorem ipsum is a placeholder text commonly used to demonstrate the </li>
                                    <li>Lorem ipsum is a placeholder text commonly used to demonstrate the </li>
            ...
            <div class="col-md-6">
                <form class="ct-form" id="careerform" method="POST" action="{{env('APP_URL')}}/career_lead">
                    @csrf
                    <div class="row">
                        ...
                        <div class="row no-gmobile">
                            <div class="col-md-6">
                                <div class="form-control input-label">
                                    <input type="file" id="onefile" name="resume_file"> <span id="val">Resume</span><span
                            ...
                            <div class="col-md-6">
                                <div class="form-control input-label">
                                    <input type="file" id="twofile" name="portfolio_file"> <span id="val2">Portfolio</span><span
