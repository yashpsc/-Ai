...
<section class="lightwhite padd-inside">
    ...
    <div class="large-container">
        ...
        <div class="row">
            ...
            <div class="caree-mobile">
                ...
                <div class="job-content">
                    ...
                    <div class="response-para">
                        ...
                        <div class="response-details">
                            <h6>Requirements</h6>
                            <p>Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder</p></div>
                    </div>
            ...
            <div class="col-md-6">
                <form class="ct-form">
                    <div class="row">
                        <div class="form-heading text-center mb-4"><h4>Apply for this Position</h4></div>
                        ...
                        <div class="row no-gmobile">
                            ...
                            <input type="file"> <span id="val">Resume</span>
 ...
 <span id="button">Choose File</span>
                        ...
                        <div class="col-12">
                            <textarea class="form-control" placeholder="Short Introduction" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                        <div class="col-12">
