...
<section class="mousescroll">
   <!-- Swiper -->
   <div class="swiper-container homemousescroll">
      <div class="slider swiper-wrapper">
         <div class="swiper-slide">
            <div class="slide-inner">
               <div class="large-container">
                  <div class="maincaption">
                     ...
                     <div class="btnblock know-more">
                        <a class="btn-epic white-txt" href="automotive_Manufacturing_industry" tabindex="0">
                           <div>
                              <span>
                                 Know More
                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
               ...
               <img src="images/indusrty_banner/Automotive-manufaturing.webp" alt="home">
            </div>
         </div>
         <div class="swiper-slide">
            <div class="slide-inner">
               <div class="large-container">
                  <div class="maincaption">
                     ...
                     <h2>Human Genome is mapped, but 85% of the human proteome is "undruggable".</h2>
                     <div class="btnblock know-more">
                        <a class="btn-epic white-txt" href="finished_vehicle_logistics_industry" tabindex="0">
                           <div>
                              <span>
                                 Know More
                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
               ...
               <img src="images/indusrty_banner/Finished_Vehicle.webp" alt="home">
            </div>
         </div>
         <div class="swiper-slide">
            <div class="slide-inner">
               ...
               <img src="images/indusrty_banner/Aftermarket.webp" alt="home">
            </div>
         </div>
         <div class="swiper-slide">
            <div class="slide-inner">
               <div class="large-container">
                  <div class="maincaption">
                     ...
                     <h2>Human Genome is mapped, but 85% of the human proteome is "undruggable".</h2>
                     <div class="btnblock know-more">
                        <a class="btn-epic white-txt" href="insurance_industry" tabindex="0">
                           <div>
                              <span>
                                 Know More
                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
               ...
               <img src="images/indusrty_banner/Insurance.webp" alt="home">
            </div>
         </div>
         <div class="swiper-slide">
            <div class="slide-inner">
               <div class="large-container">
                  <div class="maincaption">
                     ...
                     <h2>Human Genome is mapped, but 85% of the human proteome is "undruggable".</h2>
                     <div class="btnblock know-more">
                        <a class="btn-epic white-txt" href="warehousing_industry" tabindex="0">
                           <div>
                              <span>
                                 Know More
                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
               ...
               <img src="images/indusrty_banner/Warehouse.webp" alt="home">
            </div>
         </div>
         <div class="swiper-slide">
            <div class="slide-inner">
               <div class="large-container">
                  <div class="maincaption">
                     ...
                     <h2>Human Genome is mapped, but 85% of the human proteome is "undruggable".</h2>
                     <div class="btnblock know-more">
                        <a class="btn-epic white-txt" href="pharma_industry" tabindex="0">
                           <div>
                              <span>
                                 Know More
                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
               ...
               <img src="images/indusrty_banner/Pharma.webp" alt="home">
            </div>
         </div>
      </div>
   ...
   <div class="text-center">
      <div class="skipbtn skipbtnhome">
         SKIP
         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M12.6666 6L7.99992 10.4444L3.33325 6" stroke="black" stroke-linecap="round"
               stroke-linejoin="round" />
         </svg>
      </div>
   </div>
            ...
            <div id="tab-1" class="tab active text-center">
               <div class="grid-container grid-colum-7">
                  ...
                  <div class="award-list">
                     ...
                     <div class="mt-3">
                        <h3>Winner – Startup Sparks Edition 1</h3>
                     </div>
                  </div>
                  <div class="award-list">
                     <img src="images/award7.png">
                     <div class="mt-3">
                     <h3>Top 10 best startups; i2i Innovation award 2019 by Consulate General of Israel to South India</h3>
                     </div>
                  </div>
                  <div class="award-list">
...
<section class="lightwhite padd-inside">
   ...
   <div class="container">
      <div class="grid-container grid-colum-5">
         ...
         <div class="brand-list">
            <img src="/images/myntra-logo.webp">
         </div>
         <div class="brand-list">
                  ...
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <div class="caption-profile">
                           <span><img src="images/Nitin-gadkriimg.webp"></span>
                           <div class="txt-cap">
                              <h5>Nitin Gadkari</h5>
                              <h6>Minister (RT&H)</h6>
                           </div>
                        ...
                        <div class="clients-video">
                           <a data-fancybox="gallery" href="images/nitin-gadkari.mp4"><img
                                 src="images/test-video-thumb.webp"><img class="playbtn" src="images/play-02.svg"></a>
                        </div>
                     </div>
                     <div class="swiper-slide">
                        <div class="caption-profile">
            ...
            <div class="content-slider">
               <div class="swiper mySwipertestimonial">
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <div class="caption-profile">
                           <span><img src="images/myntra-profile.webp"></span>
                           <div class="txt-cap">
                              <h5>Mohan</h5>
                              <h6>Myntra</h6>
                           </div>
                        ...
                        <div class="clients-testimonial">
                           <div class="clients-scroll">
                              <p>Myntra has partnered with CamCom to build an Automated Quality Check platform for the
                                 ...
                                 happen on ground.</p>
                              <p>In the journey, the team has been very flexible to experiment and venture into new
                                 unexplored areas of AI and computer vision to suit our business requirement. Looking
                                 back, the audacious target to build this unique platform has been achieved from a team
                                 led by strong Industry leaders.</p>
                              <p>Trust me you guys have a great future in the AI Industry.</p>
                           </div>
                        </div>
                     </div>
                     <div class="swiper-slide">
               ...
               <div class="swiper mySwipertestimonialimage">
                  <div class="swiper-wrapper">
                     <div class="swiper-slide" data-bs-toggle="modal" data-bs-target="#screenzoom">
                        <div class="caption-profile">
                           <span><img src="images/fair-first.webp"></span>
                           <div class="txt-cap">
                              <h5>Sandeep Goel</h5>
                        ...
                        <div class="image-shot">
                           <a data-fancybox="gallery" href="images/pdf-image.webp"><img
                                 src="images/test-sliderimage.svg"></a>
...
<section class="lightwhite padd-inside">
   <div class="large-container">
      <div class="row align-items-center">
         ...
         <div class="col-md-6">
         <form class="enquiryform" id="myForm" method="POST" action="{{env('APP_URL')}}/contact_lead">
               @csrf
               <div class="row">
                  ...
                  <div class="col-12 position-relative">
                     <textarea name="message" class="form-control" placeholder="Message" id="exampleFormControlTextarea1" rows="5  "></textarea>
                  </div>
                  <div class="col-12 position-relative">
                  ...
                  <div class="col-12">
                     <button type="submit" class="btn w-100 mb-3 btn-submit" value="submit">Submit</button>
                     {{-- <input class="btn-epic block bg-merino text-white w-full max-w-fit max-w-full uppercase cursor-pointer" type="submit" value="submit"> --}}
                  </div>
               </div>
            </form>
         </div>
