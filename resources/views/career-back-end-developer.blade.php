        ...
        <div class="back-button text-end paddmobile">
            <p><a href="career">
                    <svg xmlns="http://www.w3.org/2000/svg" width="12" height="16" viewBox="0 0 12 16" fill="none">
                        <path
                            d="M0.292893 7.29289C-0.0976314 7.68342 -0.0976315 8.31658 0.292893 8.70711L6.65685 15.0711C7.04738 15.4616 7.68054 15.4616 8.07107 15.0711C8.46159 14.6805 8.46159 14.0474 8.07107 13.6569L2.41421 8L8.07107 2.34314C8.46159 1.95262 8.46159 1.31945 8.07107 0.92893C7.68054 0.538406 7.04738 0.538406 6.65685 0.928931L0.292893 7.29289ZM11.5 7L1 7L1 9L11.5 9L11.5 7Z"
                            fill="#A4AAAD" />
                    </svg>&nbsp;Job Openings</a>
            </p>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="caree-mobile">
                    ...
                    <h1>Software Engineer <br>Back-end Developer</h1>
                    <div class="sub-head">
                    ...
                    <div class="job-content">
                        <div class="job-description">
                            <p>At a minimum of 2 years of hands-on experience in Python and Javascript. Must have good
                                knowledge on REST APIs. Must have good knowledge of database operations.</p>
                        </div>
                    </div>
                    <div class="job-content">
                        <div class="job-description">
                            <h4>Job Description:</h4>
                            <p>We are looking for highly skilled developers who are comfortable with back-end
                                development. You will be responsible for developing backend applications, services,
                                databases.</p>
                            <p>What we seek from candidates is a sense of ownership, attention to detail, and good
                        ...
                        <div class="response-para">
                            <div class="response-details">
                                ...
                                <ul>
                                    ...
                                    <li>Develop scalable systems using Python with Flask / Django. </li>
                                    <li>Apply best coding practices, review peer code, maintain repositories on GIT.
                                    </li>
                                    <li>Create test cases for API and module level testing. </li>
                                    <li>Deploy production-grade apps/services on cloud-based environments.</li>
                                    <li>Interact with a diverse team, get the requirements, integrate modules, and test
                                        the code.</li>
                            ...
                            <div class="response-details">
                                ...
                                <ul>
                                    ...
                                    <li>Familiarity with MySQL, Redis and MongoDB.</li>
                                ...
                                <div class="response-details">
                                    <h6>Good to Have:</h6>
                                    <ul>
                                        <li>Knowledge of HTML, CSS, Javascript. Worked with JS Frameworks such as
                                            jQuery, AngularJS or VueJS.</li>
                        ...
                        <div class="row no-gmobile">
                            <div class="col-md-6 position-relative">
                                <div class="form-control input-label">
                                    <input type="file" id="onefile" name="resume_file" required> <span
                                        id="val">Resume</span><span id="button">Choose File</span>
                                </div>
                            </div>

                            <div class="col-md-6 position-relative">
                                <div class="form-control input-label">
                                    <input type="file" id="twofile" name="portfolio_file" required> <span
                                        id="val2">Portfolio</span><span id="button2">Choose File</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 position-relative">
